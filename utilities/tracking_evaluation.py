...
def print_metrics_ext(file_re_ou, header, metrics, extra_info, banner=30):
...
def print_idmetrics(file_re_ou, header, metrics, extra_info, banner=30):
    metric_names  = ['IDF1']
...
def evaluate_tracking():
    # Init file
    folder_lbl_gt_in = "/media/sugarubuntu/DataSKKU3/3_Dataset/PBVS_challenge/tmot_dataset/annotations/val/"
    folder_lbl_tr_in = "/media/sugarubuntu/DataSKKU3/3_Dataset/PBVS_challenge/tmot_dataset/annotations/val/"
    folder_re_ou     = "/media/sugarubuntu/DataSKKU3/3_Dataset/PBVS_challenge/tmot_dataset/result/"
    ...
    for seq in tqdm(list_seqs):
        ...
        file_re_ou  = os.path.join(folder_re_ou, f'{seq}_thermal.txt')
        ...
        print_metrics_ext(file_re_ou, f' Evaluation {seq}', metrics, extra_info)
        # print_idmetrics(file_re_ou, ' Evaluation', metrics, extra_info)
